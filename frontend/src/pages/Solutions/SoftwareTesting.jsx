...
const SoftwareTesting = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 overflow-x-hidden">
      ...
      <Helmet>
  {/* Primary SEO */}
  <title>Custom Software Development & QA Services | Greatodeal</title>
  <meta
    name="description"
    content="Greatodeal builds secure, scalable, custom software solutions with enterprise-grade QA & testing. From automation to performance and security testing — we ensure your software is fast, reliable, and future-ready."
  />
  <link
    rel="canonical"
    href="https://greatodeal.com/solutions/custom_software"
  />

  {/* Open Graph (Facebook, LinkedIn, WhatsApp) */}
  <meta property="og:title" content="Custom Software Development & QA Testing | Greatodeal" />
  <meta
    property="og:description"
    content="Build high-performance, secure, scalable software with Greatodeal. Our QA experts deliver flawless solutions with functional, performance, security, and automated testing."
  />
  <meta property="og:url" content="https://greatodeal.com/solutions/custom_software" />
  ...
  <meta
    name="twitter:title"
    content="Custom Software Development & QA Testing | Greatodeal"
  />
  <meta
    name="twitter:description"
    content="We create robust, secure, scalable custom software with enterprise-level QA testing — automation, performance, security & performance testing."
  />
  <meta
    name="twitter:image"
    content="https://greatodeal.com/images/softwaretesting.JPG"
